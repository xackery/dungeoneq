sub ScaleAll {
    ...
    $npc->SetLevel($level);
    plugin::ScaleLevel($npc, $level);
    plugin::ScaleAccuracy($npc, $level);
    plugin::ScaleSlowMitigation($npc, $level);
    plugin::ScaleAttack($npc, $level);
    plugin::ScaleStrength($npc, $level);
    plugin::ScaleStamina($npc, $level);
    plugin::ScaleDexterity($npc, $level);
    plugin::ScaleAgility($npc, $level);
    plugin::ScaleIntelligence($npc, $level);
    plugin::ScaleWisdom($npc, $level);
    plugin::ScaleCharisma($npc, $level);
    plugin::ScaleMagicResist($npc, $level);
    plugin::ScaleColdResist($npc, $level);
    plugin::ScaleFireResist($npc, $level);
    plugin::ScalePoisonResist($npc, $level);
    plugin::ScaleDiseaseResist($npc, $level);
    plugin::ScaleCorruptionResist($npc, $level);
    plugin::ScalePhysicalResist($npc, $level);
    plugin::ScaleMinDamage($npc, $level);
    plugin::ScaleMaxDamage($npc, $level);
    plugin::ScaleHPRegenRate($npc, $level);
    plugin::ScaleAttackDelay($npc, $level);
    plugin::ScaleAttackSpeed($npc, $level);
    plugin::ScaleSpellScale($npc, $level);
    plugin::ScaleHealScale($npc, $level);
    plugin::ScaleSpecialAbilities($npc, $level);
    plugin::ScaleAvoidance($npc, $level);
    plugin::ScaleAC($npc, $level);
    plugin::ScaleHP($npc, $level);
    plugin::ScaleSpells($npc, $level, $originalLevel);
    plugin::ScaleSpellEffects($npc, $level, $originalLevel);
}
